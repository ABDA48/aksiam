...
console.log()
  ...
  >
    {department.images.map((image, index) => (
      <div key={index}>
        <img src={`/storage/${image}`} alt={`Department ${index + 1}`} className="w-full h-[50vh] object-cover" />
      </div>
    ))}
  </Carousel>
...
<section className="w-full max-w-4xl mx-auto py-12 px-6 flex flex-col items-center text-center">
  <h2 className="text-3xl font-bold mb-4 text-center">About the Department</h2>
  <p 
  className="text-lg text-gray-600 leading-relaxed"
  dangerouslySetInnerHTML={{ __html: department.apropos }}
 />
   {/* Call to Action */}
   <motion.div 
